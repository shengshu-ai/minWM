"""HY Action2V causal-ODE few-step AR-rollout inference (4-step, CFG off)."""
...
inference = dict(
    ...
    checkpoint="./ckpts/HY15/Action2V/stage2_ar_ode",
    output_dir="outputs/hy_action2v_stage2_ar_ode",
    guidance_scale=1.0,
    dtype="bfloat16",
    seed=42,
    sp_size=1,
