"""Flow-matching scheduler with SD3 time-shift for Wan ODE sampling.

Implements forward corruption, Euler-method stepping, and training-time weighting.
"""
...
class SchedulerInterface(ABC):
    ...
    def convert_noise_to_x0(
        ...
        (eq 11 in https://arxiv.org/abs/2311.18828)
        """
        # use higher precision for calculations
