...
from ..nccl import find_nccl_library
...
class NCCLLibrary:
    ...
    def ncclAllReduce(
        ...
        self.NCCL_CHECK(
            self._funcs["ncclAllReduce"](sendbuff, recvbuff, count, datatype, op, comm, stream)
        )
    ...
    def ncclReduceScatter(
        ...
        # by ctypes automatically
        self.NCCL_CHECK(
            self._funcs["ncclReduceScatter"](sendbuff, recvbuff, count, datatype, op, comm, stream)
        )
    ...
    def ncclAllGather(
        ...
        # by ctypes automatically
        self.NCCL_CHECK(
            self._funcs["ncclAllGather"](sendbuff, recvbuff, count, datatype, comm, stream)
        )
    ...
    def ncclBroadcast(
        ...
        self.NCCL_CHECK(
            self._funcs["ncclBroadcast"](sendbuff, recvbuff, count, datatype, root, comm, stream)
        )
