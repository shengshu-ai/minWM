...
"""Stateless metadata-exchange ProcessGroup built on a TCPStore.

Used as a side-channel for groups that cannot — or should not — go through
``torch.distributed.init_process_group`` (e.g. forming overlapping groups
during NCCL bootstrap).
"""
