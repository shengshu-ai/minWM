...
# Vendored from Wan2.1 (wan/modules/t5.py); kept as-is per CLAUDE.md
# vendored-code exemption.
import logging
import math
...
class T5EncoderModel:
    ...
    def __init__(
        ...
        # Resolve the default device lazily: evaluating torch.cuda.current_device()
        # as a default arg would trip CUDA init at import time and crash on
        # CPU-only hosts (e.g. the CPU CI runner).
        if device is None:
